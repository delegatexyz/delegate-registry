...
Why? Because we can't anticipate all the future use cases for delegation today. The registry should accomodate novel and distinct roles, via an EIP-165 hashlist for specific permissions. We will hardcode NFT-specific methods to ease adoption as well.
