...
contract Deploy is Script {
    ...
    function run() external {
        ...
        DelegateRegistry saltDeploy = new DelegateRegistry{salt: zkRegistrySalt}();
        ...
        bytes32 zkBytecodeHash = ACCOUNT_CODE_STORAGE_SYSTEM_CONTRACT.getRawCodeHash(address(saltDeploy));
